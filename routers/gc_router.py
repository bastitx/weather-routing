...
class GCRouter(Router):
    ...
    def calculate_routing(self, n=20):
        ...
        d = 0
        route_points = [RoutingPoint(self.start_point.x, self.start_point.y, az, None, d, None, 0)]
        for _ in range(n):
            d += dist / n
            ...
            route_points.append(RoutingPoint(current_x, current_y, az, route_points[-1], d, None, s))
